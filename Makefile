...
.PHONY: check-qasm
check-qasm: zcc
	@echo "=== [1/3] Running OpenQASM 2.0 Parser Test Suite ==="
	@python3 tests/test_qasm_parser.py
	@echo "=== [2/3] Running OpenQASM 2.0 Statevector Simulator Test Suite ==="
	@python3 tests/test_qasm_sim.py
	@echo "=== [3/3] Running C API Native Simulator Tests ==="
	@gcc -O2 -Iinclude -I. -o /tmp/test_qasm_c_api tests/test_qasm_c_api.c src/quantum/zcc_qasm_parser.c src/quantum/zcc_qasm_sim.c -lm
	@/tmp/test_qasm_c_api
